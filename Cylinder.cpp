...
/**
* Cylinder's int  printf("Normal to Cyl X: %f\n", n.x);
  printf("Normal to Cyl Y: %f\n", n.y);
  printf("Normal to Cyl Z: %f\n",ersection method.  The input is a ray (pos, dir).
*/
